...
import { generateFretboard2, generateScaleTones, harmonicMinorScale, majorScale, melodicMinorScale, naturalMinorScale, pattern } from "../utils";
...
export default function() {
    ...
    return (
        <div className="p-2">
            ...
            <select name="scaleSelect" value={scale} onChange={(e) => setScale(e.target.value)}>
                <option value=''></option>
